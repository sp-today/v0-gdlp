-- Seed spare parts database with genuine and counterfeit parts

INSERT INTO public.spare_parts (part_name, part_number, device_type, brand, model, gs1_code, manufacturer, price, is_genuine, authenticity_verified_at) VALUES
