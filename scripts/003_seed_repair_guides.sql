-- Seed repair guides for Vernacular Fix Hub

INSERT INTO public.repair_guides (device_type, brand, model, issue_category, title, description, steps, difficulty_level, estimated_time_minutes, tools_required, language, success_rate) VALUES
('smartphone', 'Apple', 'iPhone 13', 'battery', 'Replace iPhone 13 Battery', 'Step-by-step guide to replace a degraded battery in iPhone 13', 
...
('smartphone', 'Samsung', 'Galaxy A12', 'screen', 'Replace Samsung Galaxy A12 Screen', 'Guide to replace a cracked or damaged screen', 
...
('smartphone', 'Apple', 'iPhone 13', 'charging', 'Fix iPhone 13 Charging Issues', 'Troubleshoot and fix common charging problems',
...
('smartphone', 'Samsung', 'Galaxy A12', 'software', 'Fix Samsung Galaxy A12 Software Issues', 'Resolve common software problems',
...
('smartphone', 'Apple', 'iPhone 13', 'battery', 'iPhone 13 ब्याटरी बदलें', 'iPhone 13 में खराब ब्याटरी को बदलने के लिए चरण-दर-चरण गाइड',
